...
### Recoding variables
## Country (some artists/ bands have two countries mentioned, but I will go for only one, usually birthplace)
best_selling_artists$Country[best_selling_artists$Country == 'Australia'] = 1
best_selling_artists$Country[best_selling_artists$Country == 'Barbados'] = 2
best_selling_artists$Country[best_selling_artists$Country == 'Canada'] = 3
best_selling_artists$Country[best_selling_artists$Artist == 'Justin Bieber'] = 3
best_selling_artists$Country[best_selling_artists$Country == 'Colombia'] = 4
best_selling_artists$Country[best_selling_artists$Country == 'France'] = 5
best_selling_artists$Country[best_selling_artists$Country == 'Ireland'] = 6
best_selling_artists$Country[best_selling_artists$Country == 'Jamaica'] = 7
best_selling_artists$Country[best_selling_artists$Country == 'Japan'] = 8
best_selling_artists$Country[best_selling_artists$Country == 'Spain'] = 9
best_selling_artists$Country[best_selling_artists$Country == 'Sweden'] = 10
best_selling_artists$Country[best_selling_artists$Country == 'Trinidad and Tobago'] = 11
best_selling_artists$Country[best_selling_artists$Country == 'United Kingdom'] = 12
best_selling_artists$Country[best_selling_artists$Artist == 'Bee Gees'] = 12
best_selling_artists$Country[best_selling_artists$Artist == 'Fleetwood Mac'] = 12
best_selling_artists$Country[best_selling_artists$Country == 'United States'] = 13
best_selling_artists$Country[best_selling_artists$Artist == 'Foreigner'] = 13
best_selling_artists$Country = as.factor(best_selling_artists$Country)
...
library(dplyr)
best_selling_artists = select(best_selling_artists, -c('period_active', 'Genre', 'part_1', 'part_2', 'part_3'))
